package com.app.PetCarespringsecbknd.model;
...
import com.app.PetCarespringsecbknd.converter.DurationConverter;
import com.app.PetCarespringsecbknd.converter.UUIDToByteConverter;
import com.app.PetCarespringsecbknd.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcarespringsecbknd_820\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcarespringsecbknd_820\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcarespringsecbknd_820\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcarespringsecbknd_820\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcarespringsecbknd_820\"")
